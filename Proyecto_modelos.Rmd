...
# Si p-value es menor que 0.05 entonces se debe rechazar.
# En este caso el p-value es muy pequeño, por ende, se debe rechazar H0 e indicar que existe una relación entre la variable categórica sexo y la variable predictora.
mosaicplot(TD3, color = c("#66c2a5", "#fc8d62", "#8da0cb", "gray80"), main = 'Gráfico de Mosaico', las = 1)
```
...
print(TD6)
chisq.test(TD6)
mosaicplot(TD6, color = c("#66c2a5", "#fc8d62", "#8da0cb"), main = 'Gráfico de Mosaico', las = 1)
```
...
print(TD7)
chisq.test(TD7)
mosaicplot(TD7, color = c("#66c2a5", "#fc8d62"), main = 'Gráfico de Mosaico', las = 1)
```
...
print(TD8)
chisq.test(TD8)
mosaicplot(TD8, color = c("#66c2a5", "#fc8d62"), main = 'Gráfico de Mosaico', las = 1)
```
