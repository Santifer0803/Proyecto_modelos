...
En todos los gráficos se observa una relación lineal, indicando que las variables numéricas no requieren ninguna transformación.

Como no se hace interpretación en este proyecto, las variables categóricas no son consideradas en este tipo de análisis.
