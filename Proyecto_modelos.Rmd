...
La razón de covarianza y el apalancamiento indican algunas observaciones influyentes, al igual que la métrica de dffit en el caso de Estados Unidos. Entonces, se eliminan las observaciones del modelo en las que hay una concentración de influencia, debido a que mejoran drásticamente el BIC de ambos modelos.
