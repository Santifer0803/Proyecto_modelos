...
hungria$edad_disc <-
  cut(hungria$age,
      breaks = quantile(hungria$age, probs = seq(0, 1, 0.25)),
      include.lowest = TRUE)
suiza$edad_disc <-
  cut(suiza$age,
      breaks = quantile(suiza$age, probs = seq(0, 1, 0.25)),
      include.lowest = TRUE)
europa$edad_disc <-
  cut(europa$age,
...
printCoefmat(coef(summary(modelo.eeuu)))
printCoefmat(coef(summary(modelo.hungria)))
printCoefmat(coef(summary(modelo.suiza)))
printCoefmat(coef(summary(modelo.europa)))

# Resultados con razon de verosimilitud
anova(modelo.eeuu, test = "Chisq")
anova(modelo.hungria, test = "Chisq")
anova(modelo.suiza, test = "Chisq")
anova(modelo.europa, test = "Chisq")
```
